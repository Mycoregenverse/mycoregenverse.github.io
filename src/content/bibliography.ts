 ...
 *
 * Items are numbered 1–153 with no gaps; `n` is the display number, so adding
 * or removing an entry means renumbering the ones after it.
 *
 * Each entry carries only what a reader needs to reach the source: title,
 * author, edition line, and the access links. No commentary — the list speaks
 * by what it includes and how it is grouped.
 *
 * Titles, authors and edition lines are bibliographic data — not translated
 * between languages. Section titles are.
 */
...
export const BIBLIOGRAPHY: BiblioSection[] = [
  ...
  },
  {
    ...
    items: [
      { n: 68, title: 'Cosmo-Localization and Leadership for the Future', author: 'Ramos (2017)', edition: 'Journal of Futures Studies 21(4):65–84', links: [
      ...
      { n: 69, title: 'Design global, manufacture local', author: 'Kostakis, Niaros, Dafermos & Bauwens (2015)', edition: 'Futures 73:126–135', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/j.futures.2015.09.001' },
        { kind: 'livre', href: 'https://zenodo.org/records/996189' },
      ]},
      { n: 70, title: 'Towards a political ecology of the digital economy', author: 'Kostakis, Roos & Bauwens (2016)', edition: 'Environmental Innovation and Societal Transitions 18:82–100', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/j.eist.2015.08.002' },
      ]},
      { n: 71, title: 'The convergence of digital commons with local manufacturing from a degrowth perspective', author: 'Kostakis, Latoufis, Liarokapis & Bauwens (2018)', edition: 'Journal of Cleaner Production 197:1684–1693', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/j.jclepro.2016.09.077' },
      ]},
      { n: 72, title: 'Beyond global versus local: illuminating a cosmolocal framework for convivial technology development', author: 'Kostakis, Niaros & Giotitsas (2023)', edition: 'Sustainability Science 18(5):2309–2322', links: [
        { kind: 'doi', href: 'https://doi.org/10.1007/s11625-023-01378-1' },
      ]},
      { n: 73, title: 'Cosmolocalism: Understanding the Transitional Dynamics towards Post-Capitalism', author: 'Schismenos, Niaros & Lemos (2020)', edition: 'tripleC 18(2):670–684', links: [
      ...
      { n: 74, title: 'Another Scalability is Possible! From Non-Scalability to Cosmolocal Scalability', author: 'Kostakis, Lemos & Kouvara (2024)', edition: 'tripleC 22(2):620–629', links: [
        { kind: 'doi', href: 'https://doi.org/10.31269/triplec.v22i2.1535' },
      ]},
      { n: 75, title: 'Peer to Peer: The Commons Manifesto', author: 'Michel Bauwens, Vasilis Kostakis e Alex Pazaitis', edition: 'University of Westminster Press, 2019', links: [
        { kind: 'livre', href: 'https://library.oapen.org/bitstream/id/2e3f561d-b1f5-4e7c-8da3-ccab0f00501d/UWP-033-REVISED.pdf' },
      ]},
      { n: 76, title: 'Cosmo-Local Reader', author: 'José Ramos, Sharon Ede, Michel Bauwens e James Gien Wong (orgs.)', edition: 'P2P Foundation, 2021 · 50 capítulos', links: [
        { kind: 'livre', href: 'https://clreader.net/' },
        { kind: 'livre', href: 'https://archive.org/details/cosmo-local-reader' },
      ]},
      { n: 77, title: 'P2P Foundation', author: 'organização, Países Baixos', edition: 'acervo sob CC BY-SA 4.0', links: [
  ...
  },
  {
    ...
    items: [
      { n: 78, title: 'A vida não é útil', author: 'Ailton Krenak', edition: 'Companhia das Letras, 2020', links: [
      ...
      { n: 79, title: 'O amanhã não está à venda', author: 'Ailton Krenak', edition: 'Companhia das Letras, 2020', links: [
        { kind: 'livre', href: 'https://saudeindigena.fiocruz.br/items/dc8ab5bd-c2bf-4414-8082-104104134e21' },
      ]},
      { n: 80, title: 'Futuro ancestral', author: 'Ailton Krenak', edition: 'Companhia das Letras, 2022', links: [
        { kind: 'br', href: 'https://www.companhiadasletras.com.br/livro/9786559211548/futuro-ancestral' },
      ]},
      { n: 81, title: 'Colonização, Quilombos: modos e significações', author: 'Antônio Bispo dos Santos', edition: 'INCTI/UnB, 2015', links: [
        { kind: 'livre', href: 'https://archive.org/details/bispo-antonio.-colonizacao-quilombos' },
      ]},
      { n: 82, title: 'A terra dá, a terra quer', author: 'Antônio Bispo dos Santos', edition: 'Ubu Editora e PISEAGRAMA, 2023', links: [
        { kind: 'br', href: 'https://piseagrama.org/produto/a-terra-da-a-terra-quer/' },
      ]},
      { n: 83, title: 'Metafísicas canibais', author: 'Eduardo Viveiros de Castro', edition: 'n-1 edições, 2015', links: [
        { kind: 'br', href: 'https://n-1edicoes.org/publicacoes/metafisicas-canibais/' },
      ]},
      { n: 84, title: 'Os pronomes cosmológicos e o perspectivismo ameríndio', author: 'Eduardo Viveiros de Castro', edition: 'Mana 2(2):115–144, 1996', links: [
      ...
      { n: 85, title: 'O barro, o genipapo e o giz no fazer epistemológico de autoria Xakriabá', author: 'Célia Nunes Corrêa (Célia Xakriabá)', edition: 'dissertação de mestrado, UnB, 2018', links: [
        { kind: 'livre', href: 'https://repositorio.unb.br/handle/10482/34103' },
      ]},
      { n: 86, title: 'Amansar o giz', author: 'Célia Xakriabá', edition: 'PISEAGRAMA n. 14, 2020', links: [
  ...
  },
  {
    ...
    items: [
      { n: 87, title: 'Restauração Florestal', author: 'Pedro H. S. Brancalion, Ricardo R. Rodrigues e Sergius Gandolfi', edition: 'Oficina de Textos, 2015', links: [
        { kind: 'editora', href: 'https://www.ofitexto.com.br/restauracao-florestal/p' },
      ]},
      { n: 88, title: 'Pacto pela Restauração da Mata Atlântica: referencial dos conceitos e ações de restauração florestal', author: 'R. R. Rodrigues, P. H. S. Brancalion e I. Isernhagen (orgs.)', edition: '2009', links: [
        { kind: 'livre', href: 'https://cms.sosma.org.br/wp-content/uploads/2015/03/referencial-teorico.pdf' },
      ]},
      { n: 89, title: 'Boas práticas para o monitoramento da restauração na Mata Atlântica', author: 'Mater Natura', edition: 'supervisão de Ricardo A. G. Viani', links: [
        { kind: 'livre', href: 'https://pactomataatlantica.org.br/wp-content/uploads/2026/08/Boas-Praticas-Monitoramento-v2.pdf' },
      ]},
      { n: 90, title: 'Manejo ecológico do solo: a agricultura em regiões tropicais', author: 'Ana Maria Primavesi', edition: 'Editora Nobel / Expressão Popular', links: [
      ...
      { n: 91, title: 'Agroecologia: bases científicas para uma agricultura sustentável', author: 'Miguel Altieri', edition: 'Expressão Popular e AS-PTA', links: [
        { kind: 'livre', href: 'https://agroecologia.org.br/2012/03/19/agroecologia-bases-cientificas-para-uma-agricultura-sustentavel/' },
      ]},
      { n: 92, title: 'Homem e natureza: cultura na agricultura', author: 'Ernst Götsch', edition: 'Centro Sabiá, Recife, 2ª ed.', links: [
      ...
      { n: 93, title: 'O renascer da agricultura', author: 'Ernst Götsch', edition: 'cartilha, AS-PTA', links: [
        { kind: 'livre', href: 'https://aspta.org.br/2014/09/27/cartilha-o-renascer-da-agricultura/' },
      ]},
      { n: 94, title: 'Syntropic farming systems for reconciling productivity, ecosystem functions, and restoration', author: '—', edition: 'The Lancet Planetary Health, 2025', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/S2542-5196(25)00047-6' },
      ]},
      { n: 95, title: 'Trees shape the soil microbiome of a temperate agrosilvopastoral and syntropic agroforestry system', author: 'Vaupel, Küsters, Toups, Herwig, Bösel & Beule (2025)', edition: 'Scientific Reports', links: [
        { kind: 'doi', href: 'https://doi.org/10.1038/s41598-025-85556-4' },
      ]},
      { n: 96, title: 'Agro-Successional Restoration as a Strategy to Facilitate Tropical Forest Recovery', author: 'Vieira, Holl & Peneireiro (2009)', edition: 'Restoration Ecology', links: [
        { kind: 'doi', href: 'https://doi.org/10.1111/j.1526-100X.2009.00570.x' },
      ]},
      { n: 97, title: 'Flora e Funga do Brasil', author: 'Instituto de Pesquisas Jardim Botânico do Rio de Janeiro', edition: 'base de dados oficial', links: [
      ...
      { n: 98, title: 'Brazilian Flora 2020: Leveraging the power of a collaborative scientific network', author: 'The Brazil Flora Group (2022)', edition: 'TAXON', links: [
        { kind: 'doi', href: 'https://doi.org/10.1002/tax.12640' },
        { kind: 'livre', href: 'https://hal.science/hal-03550554/' },
      ]},
      { n: 99, title: 'Diversity of Brazilian Fungi', author: 'Maia e colaboradores (2015)', edition: 'Rodriguésia 66:1033–1045', links: [
      ...
      { n: 100, title: 'Indicator species and community structure of gasteroid fungi (Agaricomycetes, Basidiomycota) in ecosystems of the Atlantic Forest in southern Brazil', author: '—', edition: 'Brazilian Journal of Botany, 2018', links: [
  ...
  },
  {
    ...
    items: [
      { n: 101, title: 'A General Framework for Analyzing Sustainability of Social-Ecological Systems', author: 'Ostrom (2009)', edition: 'Science 325(5939):419–422', links: [
        { kind: 'doi', href: 'https://doi.org/10.1126/science.1172133' },
        { kind: 'livre', href: 'https://hdl.handle.net/11059/14638' },
      ]},
      { n: 102, title: 'Beyond Markets and States: Polycentric Governance of Complex Economic Systems', author: 'Ostrom (2010)', edition: 'American Economic Review 100(3):641–672', links: [
        { kind: 'doi', href: 'https://doi.org/10.1257/aer.100.3.641' },
      ]},
      { n: 103, title: 'Revisiting the Commons: Local Lessons, Global Challenges', author: 'Ostrom, Burger, Field, Norgaard & Policansky (1999)', edition: 'Science 284(5412):278–282', links: [
        { kind: 'doi', href: 'https://doi.org/10.1126/science.284.5412.278' },
      ]},
      { n: 104, title: 'Polycentric systems for coping with collective action and global environmental change', author: 'Ostrom (2010)', edition: 'Global Environmental Change 20(4):550–557', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/j.gloenvcha.2010.07.004' },
      ]},
      { n: 105, title: 'Resilience and Stability of Ecological Systems', author: 'C. S. Holling (1973)', edition: 'Annual Review of Ecology and Systematics 4:1–23', links: [
        { kind: 'doi', href: 'https://doi.org/10.1146/annurev.es.04.110173.000245' },
      ]},
      { n: 106, title: 'Resilience, Adaptability and Transformability in Social-ecological Systems', author: 'Walker, Holling, Carpenter e Kinzig (2004)', edition: 'Ecology and Society 9(2):5', links: [
        { kind: 'doi', href: 'https://doi.org/10.5751/ES-00650-090205' },
        { kind: 'livre', href: 'https://www.ecologyandsociety.org/vol9/iss2/art5/' },
      ]},
      { n: 107, title: 'Resilience: The emergence of a perspective for social–ecological systems analyses', author: 'Carl Folke (2006)', edition: 'Global Environmental Change 16(3):253–267', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/j.gloenvcha.2006.04.002' },
      ]},
      { n: 108, title: 'Navigating Social-Ecological Systems: Building Resilience for Complexity and Change', author: 'Berkes, Colding e Folke (orgs.)', edition: 'Cambridge University Press', links: [
        { kind: 'doi', href: 'https://doi.org/10.1017/CBO9780511541957' },
      ]},
      { n: 109, title: 'What if… the United States of America were based on watersheds?', author: 'G. Kauffman (2002)', edition: 'Water Policy 4(1):57–68', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/S1366-7017(02)00019-3' },
      ]},
      { n: 110, title: 'Going with the flow: river basins as the natural units for water management?', author: 'Warner, Wester e Bolding (2008)', edition: 'Water Policy 10(S2):121–138', links: [
      ...
      { n: 111, title: 'River-basin planning and management: The social life of a concept', author: 'F. Molle (2009)', edition: 'Geoforum 40(3):484–494', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/j.geoforum.2009.03.004' },
      ]},
      { n: 112, title: 'Comitês de Bacia no Brasil: uma abordagem política no estudo da participação social', author: 'Abers e Keck (2004)', edition: 'Revista Brasileira de Estudos Urbanos e Regionais 6(1)', links: [
      ...
      { n: 113, title: 'Lei nº 9.433, de 8 de janeiro de 1997 — Política Nacional de Recursos Hídricos', author: 'Brasil', edition: 'a Lei das Águas', links: [
  ...
  },
  {
    ...
    items: [
      { n: 114, title: 'Banco Palmas', author: 'banco comunitário de desenvolvimento e moeda social', edition: 'Conjunto Palmeiras, Fortaleza-CE, fundado em 1998', links: [
        { kind: 'site', href: 'https://bancopalmas.com/' },
      ]},
      { n: 115, title: 'Bancos comunitários de desenvolvimento e a economia solidária: para além da inclusão bancária', author: 'França Filho, Silva Jr. & Rigo (2012)', edition: 'RAUSP 47(3):500–515', links: [
        { kind: 'doi', href: 'https://doi.org/10.5700/rausp1054' },
        { kind: 'livre', href: 'https://base.socioeco.org/docs/arq_12.pdf' },
      ]},
      { n: 116, title: 'O paradoxo das Palmas', author: 'Rigo & França Filho (2017)', edition: 'Cadernos EBAPE.BR 15(1):169–193', links: [
        { kind: 'livre', href: 'https://bibliotecadigital.fgv.br/ojs/index.php/cadernosebape/article/view/41258' },
      ]},
      { n: 117, title: 'Título abreviado não localizado', author: 'Rigo, França Filho & Leal (2015)', edition: 'Desenvolvimento em Questão 13(31):70–107', links: [
      ...
      { n: 118, title: 'Aplica o arcabouço de Ostrom aos bancos comunitários brasileiros', author: 'Hudon & Meyer (2016)', edition: 'Nonprofit and Voluntary Sector Quarterly 45(4S)', links: [
        { kind: 'doi', href: 'https://doi.org/10.1177/0899764016643609' },
      ]},
      { n: 119, title: 'Título abreviado não localizado', author: 'Cernev & Diniz (2020)', edition: 'RAC 24(5):487–506', links: [
      ...
      { n: 120, title: 'Título abreviado não localizado', author: 'Fare, De Freitas & Meyer (2015)', edition: 'International Journal of Community Currency Research 19(2):6–17', links: [
        { kind: 'doi', href: 'https://doi.org/10.15133/j.ijccr.2015.002' },
      ]},
      { n: 121, title: 'Diagnóstico dos bancos comunitários do Nordeste', author: 'Leal, Rigo & Andrade (2016)', edition: 'IPEA, Mercado de Trabalho n. 60', links: [
        { kind: 'livre', href: 'https://www.ipea.gov.br/' },
      ]},
      { n: 122, title: 'Texto para Discussão 2843', author: 'IPEA (2023)', edition: 'panorama nacional dos bancos comunitários — 148 bancos em 23 estados + DF', links: [
        { kind: 'livre', href: 'https://repositorio.ipea.gov.br/bitstream/11058/11737/1/TD_2843_web.pdf' },
      ]},
      { n: 123, title: 'Working Paper — sustentabilidade financeira dos bancos comunitários', author: 'Meyer (2013)', edition: 'UN NGLS', links: [
        { kind: 'livre', href: 'https://cdn.unrisd.org/assets/legacy-files/301-info-files/DD421F591071F8E2C1257B7400310FC6/Meyer.pdf' },
      ]},
      { n: 124, title: 'The Road Back to Serfdom', author: 'Mandache (2020)', edition: 'Latin American Perspectives 47(4)', links: [
        { kind: 'doi', href: 'https://doi.org/10.1177/0094582X20903275' },
      ]},
      { n: 125, title: 'Título abreviado não localizado', author: 'Sevilla (2025)', edition: 'Cadernos do Desenvolvimento Fluminense n. 29', links: [
        { kind: 'doi', href: 'https://doi.org/10.12957/cdf.2025.90430' },
      ]},
      { n: 126, title: 'Grassroots Economics / Sarafu Network', author: 'fundada por Will Ruddick', edition: 'Quênia, a partir de 2010', links: [
        { kind: 'site', href: 'https://www.grassrootseconomics.org/' },
        { kind: 'site', href: 'https://www.sarafu.network/' },
      ]},
      { n: 127, title: 'Sarafu Community Inclusion Currency 2020–2021', author: 'Mattsson, Criscione & Ruddick (2022)', edition: 'Scientific Data (Nature) 9:426', links: [
        { kind: 'doi', href: 'https://doi.org/10.1038/s41597-022-01539-4' },
        { kind: 'dataset', href: 'https://doi.org/10.5255/UKDA-SN-855142' },
      ]},
      { n: 128, title: 'Título abreviado não localizado', author: 'Mattsson, Criscione & Takes (2023)', edition: 'Scientific Reports 13:5864', links: [
        { kind: 'doi', href: 'https://doi.org/10.1038/s41598-023-33184-1' },
      ]},
      { n: 129, title: 'Título abreviado não localizado', author: 'Ba, Zignani & Gaito (2023)', edition: 'Future Generation Computer Systems 148:266–279', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/j.future.2023.05.022' },
      ]},
      { n: 130, title: 'Título abreviado não localizado', author: 'Criscione (2025)', edition: 'Journal of Complex Networks 13(3):cnaf005', links: [
        { kind: 'doi', href: 'https://doi.org/10.1093/comnet/cnaf005' },
        { kind: 'preprint', href: 'https://arxiv.org/abs/2409.13674' },
      ]},
      { n: 131, title: 'Community Currencies as Crisis Response: Results From a Randomized Control Trial in Kenya', author: 'Mqamelo (2022)', edition: 'Frontiers in Blockchain 4:739751', links: [
        { kind: 'doi', href: 'https://doi.org/10.3389/fbloc.2021.739751' },
      ]},
      { n: 132, title: 'Revisão sistemática de moedas comunitárias', author: 'Michel & Hudon (2015)', edition: 'Ecological Economics 116:160–171', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/j.ecolecon.2015.04.023' },
      ]},
      { n: 133, title: 'Blockchain humanitarianism and crypto-colonialism', author: 'Jutel (2022)', edition: 'Patterns (Cell) 3(1):100422', links: [
        { kind: 'doi', href: 'https://doi.org/10.1016/j.patter.2021.100422' },
      ]},
      { n: 134, title: 'Título abreviado não localizado', author: 'Ussher, Ebert, Gómez & Ruddick (2021)', edition: 'Journal of Risk and Financial Management 14(11):557', links: [
        { kind: 'doi', href: 'https://doi.org/10.3390/jrfm14110557' },
      ]},
      { n: 135, title: 'Estudo de campo em Kilifi sobre a prática de ROLA', author: 'Evite (2026)', edition: 'International Journal of Community Currency Research', links: [
        { kind: 'doi', href: 'https://doi.org/10.26034/zh.ijccr.2026.9556' },
      ]},
      { n: 136, title: 'Modelagem de sistemas complexos das moedas de inclusão comunitária', author: 'financiada pela Cruz Vermelha Dinamarquesa, com a BlockScience', edition: 'Computational Economics (Springer), 2023', links: [
  ...
  },
  {
    ...
    items: [
      { n: 137, title: 'O Retorno do Território', author: 'Milton Santos, em Território: Globalização e Fragmentação', edition: 'Hucitec/ANPUR, 1994', links: [
        { kind: 'livre', href: 'https://anpur.org.br/wp-content/uploads/1995/07/Territorio_globalizacao-e-fragmentacao.pdf' },
      ]},
      { n: 138, title: 'A Natureza do Espaço: Técnica e Tempo, Razão e Emoção', author: 'Milton Santos', edition: '1ª ed. Hucitec, 1996 · ed. corrente: Edusp, 4ª ed., 2006', links: []},
      { n: 139, title: 'O Brasil: Território e Sociedade no Início do Século XXI', author: 'Milton Santos e Maria Laura Silveira', edition: 'Editora Record, 2001', links: []},
      { n: 140, title: 'Do território ao território usado: possibilidades entreabertas na ciência geográfica', author: 'Jesus e Vilar (2022)', edition: 'Geografia em Atos 6', links: [
      ...
      { n: 141, title: 'A Era do Capital Improdutivo', author: 'Ladislau Dowbor', edition: 'Outras Palavras & Autonomia Literária, 2017/2018', links: [
        { kind: 'livre', href: 'https://dowbor.org/wp-content/uploads/2018/11/Dowbor-_-A-ERA-DO-CAPITAL-IMPRODUTIVO.pdf' },
      ]},
      { n: 142, title: 'Democracia Econômica: Alternativas de Gestão Social', author: 'Ladislau Dowbor', edition: '1ª ed. Banco do Nordeste, 2007 · 2ª ed. Vozes, 2008', links: [
        { kind: 'livre', href: 'https://dowbor.org/wp-content/uploads/2020/08/12-DemoEco1.pdf' },
      ]},
      { n: 143, title: 'Epistemologias do Sul', author: 'Boaventura de Sousa Santos e Maria Paula Meneses (orgs.)', edition: 'Almedina/CES-Universidade de Coimbra, 2009 · ed. BR: Cortez, 2010', links: []},
      { n: 144, title: 'Beyond Abyssal Thinking: From Global Lines to Ecologies of Knowledges', author: 'Boaventura de Sousa Santos (2007)', edition: 'Review (Fernand Braudel Center) 30(1):45–89', links: [
        { kind: 'livre', href: 'https://www.ces.uc.pt/bss/documentos/AbyssalThinking.pdf' },
      ]},
      { n: 145, title: 'Introdução à Economia Solidária', author: 'Paul Singer', edition: 'Editora Fundação Perseu Abramo, 2002', links: [
        { kind: 'livre', href: 'https://fpabramo.org.br/wp-content/uploads/2018/04/Introducao-economia-solidaria-WEB-1.pdf' },
      ]},
      { n: 146, title: 'Desenvolvimento capitalista e desenvolvimento solidário', author: 'Paul Singer (2004)', edition: 'Estudos Avançados 18(51):7–22', links: [
  ...
  },
  {
    ...
    items: [
      { n: 147, title: 'Cadernos de Agroecologia', author: 'ABA-Agroecologia', edition: 'anais dos Congressos Brasileiros de Agroecologia', links: [
        { kind: 'site', href: 'https://cadernos.aba-agroecologia.org.br/cadernos' },
      ]},
      { n: 148, title: 'Revista Brasileira de Agroecologia', author: 'ABA-Agroecologia + PPG MADER/UnB', edition: 'CC BY, sem taxa de publicação', links: [
        { kind: 'site', href: 'https://periodicos.unb.br/index.php/rbagroecologia' },
        { kind: 'livre', href: 'https://doaj.org/toc/1980-9735' },
      ]},
      { n: 149, title: 'Agriculturas: Experiências em Agroecologia', author: 'AS-PTA', edition: 'acervo até ~2018–2019', links: [
        { kind: 'site', href: 'https://aspta.org.br/revista-agriculturas/' },
      ]},
      { n: 150, title: 'Desenvolvimento e Meio Ambiente', author: 'UFPR', edition: 'CC BY 4.0, sem embargo', links: [
        { kind: 'site', href: 'https://revistas.ufpr.br/made' },
        { kind: 'livre', href: 'https://doaj.org/toc/2176-9109' },
      ]},
      { n: 151, title: 'Ambiente & Sociedade', author: 'ANPPAS, hospedado no SciELO', edition: 'acesso aberto desde 1999, CC BY-NC', links: [
        { kind: 'site', href: 'https://www.scielo.br/j/asoc/' },
        { kind: 'livre', href: 'https://doaj.org/toc/1414-753X' },
      ]},
      { n: 152, title: 'Sustentabilidade em Debate', author: 'Centro de Desenvolvimento Sustentável/UnB', edition: 'dossiês em economia ecológica e bioeconomia desde 2010', links: [
        { kind: 'site', href: 'https://periodicos.unb.br/index.php/sust' },
        { kind: 'livre', href: 'https://doaj.org/toc/2179-9067' },
      ]},
      { n: 153, title: 'Revista Iberoamericana de Economía Ecológica (REVIBEC)', author: 'REDIBEC', edition: 'rede regional da qual a ECOECO é membro', links: [
